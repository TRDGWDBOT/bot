...
def _simulate_one_strategy(candles: List[dict], strategy_name: str, confirm_need: int,
...
def run_backtest(candles: List[dict], strategy_names: List[str], confirm_need: int,
    ...
    return {
        ...
        "params": {"confirm_need": confirm_need, "tp_pct": tp_pct, "sl_pct": sl_pct,
                    "multiplier": multiplier, "stake": stake},
        "results": results,
    }
