...
export default function App() {
  ...
  return (
    <div className="app" data-testid="app">
      ...
      <div className="tab-bar" style={{ display: "flex", overflowX: "auto", gap: 6, padding: "8px 14px", borderBottom: "1px solid var(--border, #2a2d36)", position: "sticky", top: 0, zIndex: 150, background: "var(--bg0, #04060f)" }}>
        {[
          ["trading", "TRADING"],
          ["auto", "AUTOMAZIONE"],
          ["backtest", "BACKTEST"],
          ...
          return (
            <div key={sym} style={{ border: "1px solid var(--border, #2a2d36)", borderRadius: 8, padding: 10, marginBottom: 10 }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }}>
                <div style={{ fontWeight: 600 }}>{SYMBOL_LABELS[sym] || sym}</div>
                <button
