  ...
  return (
    <div className="app" data-testid="app">
      ...
      <div className="risk-card">
        ...
        {backtestRunning && <div style={{ fontSize: 11, color: "var(--text2, #888)", marginTop: 6 }}>Con molte candele storiche (vicino a 10000) può richiedere fino a 1-2 minuti — Deriv risponde a pagine, non tutto insieme.</div>}
