    ...
    <div className="app" data-testid="app">
      ...
      <div className="risk-card">
        ...
        <div className="risk-grid">
          ...
          <div className="risk-field"><label>N. candele storiche (max 5000)</label><input type="number" value={backtestCount} onChange={(e) => setBacktestCount(e.target.value)} min="100" max="5000"/></div>
        </div>
